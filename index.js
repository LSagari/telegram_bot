...
bot.start((ctx) => {
  ctx.reply("Welcome to Likhitha Sagari's bot");
});
...
bot.command("about", (ctx) =>
  ctx.reply(`This is a bot created by Likhitha Sagari
It is created using the Telegraf library
    `)
);

bot.command("contact", (ctx) =>
  ctx.reply("You can contact the bot creator at contact@sagari.live")
);
